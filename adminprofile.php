...
if (isset($_POST['submit']))
{
            ...
            $select = "UPDATE admin SET name='$name', contact='$contact', address='$address' where email='$email'";
            $result = $conn->query($select);
             header("location:adminprofile.php?msg=0");
...
<div class="container">
    ...
    <div class="middle">
        ...
        <form action="adminprofile.php" method="POST" enctype="multipart/form-data" id="myform">
